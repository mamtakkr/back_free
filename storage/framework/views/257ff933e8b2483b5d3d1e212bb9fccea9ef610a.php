      ...
      <div class="container">
        <div class="row">
          <nav>
            ...
            <div class="menu">
              <ul>
                <li><a class="bg-standard-violet rounded-left text-white px-2 py-2 active" href="<?php echo e(route('login')); ?>"><?php echo e(__('public.Login')); ?></a></li>
                <li><a class="bg-standard-violet rounded-right  text-white px-2 py-2" href="<?php echo e(route('registerType')); ?>"><?php echo e(__('public.Register')); ?></a></li>
                <!---->
              </ul>
            </div>
          </nav>
          ...
          <div class="user-credentials ">
            ...
            <form action="<?php echo e(route('login')); ?>" method="post" class="louy login-form ">
              ...
              <div class="form-group form-label-group ">
                ...
                <?php endif; ?>
                <label class="white"><?php echo e(__('public.Email')); ?></label>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group form-label-group">
                <label class="white"><?php echo e(__('public.Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="row">
                <div class="col-8">
                  <p class="white" ><?php echo e(__('public.iam_professional')); ?></p>
                </div>
                <div class="col-4">
              ...
              <div class="form-group text-center mt-3">
                <input type="submit" value="<?php echo e(__('public.Login')); ?>" class="button mb-3 loci button d-block pt-1 pb-1 w-100 h-auto bg-standard-violet base-radius text-white text-uppercase font-weight-normal mx-auto">
              </div>
            </form>
          </div>
          <div class="row">
            <div class="col-6 mt-3"> <?php if(Route::has('password.request')): ?> <a href="<?php echo e(route('password.request')); ?>" class="text-muted"><?php echo e(__('public.Forgot_Password')); ?></a> <?php endif; ?> </div>
            <div class="col-6 mt-3"> <a href="<?php echo e(route('registerType')); ?>" class="text-muted"><?php echo e(__('public.Signup')); ?></a> </div>
          </div>
        </div>
      </div>
    </div>
...
<?php /**PATH /home/demogswebtech/public_html/freely/resources/views/auth/login.blade.php ENDPATH**/ ?>