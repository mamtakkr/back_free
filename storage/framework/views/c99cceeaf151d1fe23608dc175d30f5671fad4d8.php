      ...
      <div class="col-sm-12 col-12 post-comment">
        <form action="#" method="POST" class="add_comment_form" id="myFrm<?php echo e($post->id); ?>" enctype="multipart/form-data">
          ...
          <div class="gter text-center emoji-picker-container">
            ...
            <button type="submit" id="add_comment_btn" class="bg-standard-violet text-while"><?php echo e(__('public.Publish')); ?></button>
          </div>
        </form>
      </div>
    </div>
...
<?php else: ?>
<div class="coment mt-3 rounded">
  <h1 class="text-center text-secondary my-5"><?php echo e(__('public.No_record_found')); ?></h1>
</div>
<?php endif; ?>
...
<script>
  ...
  $(document).on('submit', ".add_comment_form", function(e) {
    ...
    var thiss = $(this);
    thiss.closest('.post-comment').find("#add_comment_btn").text("<?php echo e(__('public.Adding')); ?>");
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if (response.status == 200) {
          ...
          thiss.closest('.post-comment').find("#add_comment_btn").text("<?php echo e(__('public.Publish')); ?>");
...
</script><?php /**PATH /home/demogswebtech/public_html/freely/resources/views/posts/show_all_posts.blade.php ENDPATH**/ ?>