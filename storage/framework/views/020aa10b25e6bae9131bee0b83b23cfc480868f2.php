  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('public.Add_New_Photo')); ?></h5>
      ...
      <form action="#" method="POST" id="add_photo_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <input type="hidden" name="user_id" value="<?php echo e(Auth::user()->id); ?>">
			...
			<div class="my-2">
            <label for="avatar"><?php echo e(__('public.Select_Mode')); ?></label>
            <select name="photo_type" class="form-control" required>
			<option value="1"><?php echo e(__('public.Public')); ?></option>
			<option value="0"><?php echo e(__('public.Private')); ?></option>
			</select>
          </div><br>
          
          <div class="my-2">
            <label for="avatar"><?php echo e(__('public.Select_Photo')); ?></label>
        ...
        <div class="modal-footer">
          <button type="submit" id="add_photo_btn" class="border-0 py-2 px-3 rounded bg-standard-violet text-white"><?php echo e(__('public.Add_Photo')); ?></button>
        </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="addVideoModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('public.Add_New_Video')); ?></h5>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <form action="#" method="POST" id="add_video_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="my-2">
            ...
            <label class="py-2 px-3 border-0 rounded bg-standard-violet text-white" onClick="$('#video').trigger('click');"><?php echo e(__('public.Select_Video')); ?></label>
        ...
        <div class="modal-footer">
          <button type="submit" id="add_video_btn" class="py-2 px-3 border-0 rounded bg-standard-violet text-white"><?php echo e(__('public.Add_Video')); ?></button>
        </div>
      </form>
    </div>
  </div>
