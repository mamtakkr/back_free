	...
	<ul>
        ...
        <?php if($messages->count()>0): ?>
        	...
        	<li class="incoming sent">
        		...
        		<p><?php echo e($msg->message); ?> <br> <span class="time_chat"><?php echo e($msg->created_at->diffForHumans(null,false,true)); ?></span></p>
        	</li>
        	<?php else: ?>
...
<div class="message-input" id="replySection">
	<div class="message-input" id="replyContainer">
		<div class="wrap emoji-picker-container">
		    <input class="chatMessage" type="text" name="message" data-emojiable="true" id="chatMessage<?php echo e($user->id); ?>" autocomplete="off"  placeholder="<?php echo e(__('public.Write_your_message')); ?>">
