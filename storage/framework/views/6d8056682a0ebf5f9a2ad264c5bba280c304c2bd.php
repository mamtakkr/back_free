...
$(function() {
        ...
        $("#add_post_btn").text("<?php echo e(__('public.Adding')); ?>");
        $.ajax({
          ...
          success: function(response) {
            if (response.status == 200) {
              fetchAllPosts();
                $("#add_post_btn").text("<?php echo e(__('public.Published')); ?>");
            ...
            if (response.status == 401) {
                ...
                $("#add_post_btn").text("<?php echo e(__('public.Not_Published')); ?>");
                $("#add_post_form")[0].reset(); 
            }
          },
		  error: function(err)
     ...
     // fetch all posts ajax request
      ...
      function fetchAllPosts() {
        $.ajax({
          url: '<?php echo e(route('fetchAllPosts')); ?>',
          method: 'get',
          success: function(response) {
...
</html><?php /**PATH /home/demogswebtech/public_html/freely/resources/views/layouts/partials/auth_footer.blade.php ENDPATH**/ ?>