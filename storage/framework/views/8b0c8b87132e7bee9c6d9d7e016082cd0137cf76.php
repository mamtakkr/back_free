...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-12 col-md-6 col-sm-6">
            <p style="text-align:center; font-weight:bold; color:#ff128e;"><?php echo e(__('public.subscriptions_page')); ?> <br> <?php echo e(__('public.choose_subscription')); ?></p>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-12 heading">
                        ...
                        <?php if(!empty(auth()->user()->plan_id) && auth()->user()->plan_id == $plan->id): ?>
                            <center><p><?php echo e(__('public.Start_Date')); ?> <?php echo e(date('d M Y',strtotime(auth()->user()->subscribe_date))); ?> <br> <?php echo e(__('public.End_Date')); ?> <?php echo e(date('d M Y',strtotime(auth()->user()->ends_at))); ?></p></center>
                            <?php if(auth()->user()->ends_at > date('Y-m-d')): ?>
                            <center><p><?php echo e(__('public.Days_Remaining')); ?> <?php echo e(Carbon::now()->diffInDays(\Carbon\Carbon::parse(auth()->user()->ends_at))); ?> <?php echo e(__('public.days')); ?></p></center>
                            <?php else: ?>
                            <center><p><?php echo e(__('public.Expired')); ?></center></p>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                    <div class="col-12 px-0 heading">
                        ...
                        <center>
                            <?php if(!empty(auth()->user()->plan_id) && auth()->user()->ends_at > date('Y-m-d')): ?>
                                ...
                                <p class="btn btn-empty btn-pink"><?php echo e(__('public.Activated')); ?></p>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo e(route('payment-method',Crypt::encrypt($plan->id))); ?>" class="btn btn-empty btn-pink"><?php echo e(__('public.Choose_Plan')); ?></a>
                            <?php endif; ?>
