...
<div class="container">
			...
			<div id="sidepanel">
                  <!-- <form action="#" method="POST" id="search_form" enctype="multipart/form-data">
    				...
    				<div id="search"> -->
    					...
    					<input type="text" class="form-control" name="sample_search" id="sample_search" placeholder="<?php echo e(__('public.Search_contacts')); ?>">
			...
			<?php if(!empty($currentSession)): ?>
					...
					<ul>
                        ...
                        <?php if($msg->sender_id==auth()->user()->id && $msg->receiver_id==$user->id || $msg->sender_id==$user->id && $msg->receiver_id==auth()->user()->id): ?>
                        	...
                        	<li class="incoming sent">
                        		...
                        		<p class="chat_new_message_out"><?php echo e($msg->message); ?> <br> <span class="time_chat"><?php echo e($msg->created_at->diffForHumans(null,false,true)); ?></span></p>
                        	</li>
                        	<?php else: ?>
                        	<li class="outgoing sent">
                        	    <img width="22px" height="22px" src="<?php echo e(URL::to('/')); ?>/public/images/users/<?php echo e($msg->relSender->image_url); ?>" alt="<?php echo e($msg->relSender->username); ?>">
                        		<p class="chat_new_message_in"><?php echo e($msg->message); ?> <br> <span class="time_chat"><?php echo e($msg->created_at->diffForHumans(null,false,true)); ?></span></p>
                        	</li>
                        	<?php endif; ?>
                        <?php endif; ?>
                    	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="message-input" id="replySection">
						<div class="wrap emoji-picker-container">
						    <input class="chatMessage" type="text" name="message" data-emojiable="true" data-id="chatMessage<?php echo e($userDetails->id); ?>" id="chatMessage<?php echo e($userDetails->id); ?>" autocomplete="off"  placeholder="<?php echo e(__('public.Write_your_message')); ?>">
   ...
   <!--                 </ul>-->
			<!--	</div>-->
			<div class="contact-profile" id="userSection">
					<?php echo e(__('public.Start_Conversation')); ?>
