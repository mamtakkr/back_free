      ...
      <div class="row">
        <div class="col-md-6">
          <div class="photos mt-5">
            ...
            <button class="boder py-2 px-3 mt-3 rounded bg-standard-violet text-white float-right new_phot_section" style="margin-top:-54px !important;" data-toggle="modal" data-target="#addPhotoModal">{{__('public.Add_Photo')}}</button>
        ...
        <div class="col-md-6">
          <div class="photos mt-5">
            <p class="text-white">Photo <span class="public">{{__('public.Private')}}</span></p>
...
<script>
    $(function() {
      ...
      $("#add_photo_form").submit(function(e) {
        ...
        $("#add_photo_btn").text("{{ __('public.Adding') }}");
        $.ajax({
