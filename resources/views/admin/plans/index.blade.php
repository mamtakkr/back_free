            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('public.Plans')}}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <!--{{--<div align="right">-->
                    <!--    <a href="{{route('plan-create')}}" class="btn btn-primary">Add New Plan</a><br>-->
                    <!--</div>--}}-->
                                    ...
                                    <table class="table table-striped table-bordered bulk_action datatable-checkbox">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{__('public.Plan_Type')}}</th>
                                                <th>{{__('public.Trial_Days')}}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" href="{{route('plan-edit',$row['id'])}}"><i class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
