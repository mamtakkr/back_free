            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('public.Add_Plan')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="tab-pane ladre" id="settings">
                                <form method="post" action="{{route('plan-store')}}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="price" class="form-control" placeholder="{{__('public.Price')}}" value="{{old('price')}}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="trial_days" class="form-control" placeholder="{{__('public.Trial_Days')}}" value="{{old('trial_days')}}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="plan_type" class="form-control">
                                              ...
                                              <option value="monthly" @if(old('plan_type')=="monthly" ) {{ 'selected' }} @endif>{{__('public.Monthly')}}</option>
                                              <option value="yearly" @if(old('plan_type')=="yearly" ) {{ 'selected' }} @endif>{{__('public.Yearly')}}</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea name="description" id="myeditor" class="form-control desyt" placeholder="{{__('public.Description')}}">{{old('description')}}</textarea>
                                        </div>
                                    </div>
