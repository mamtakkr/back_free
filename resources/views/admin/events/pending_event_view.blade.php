                                            ...
                                            <div class="col-md-12">
                                                <div class="row emi_row">
                                                    <div class="col-6 trta">
                                                        <h4><b>{{__('public.Username')}}</b></h4>
                                                        <h4><b>{{__('public.Title')}}</b></h4>
                                                        <h4><b>{{__('public.Event_type')}}</b></h4>
                                                        <h4><b>{{__('public.Event_Category')}}</b></h4>
                                                        <h4><b>{{__('public.Address')}}</b></h4>
                                                        <h4><b>{{__('public.Postal_Code')}}</b></h4>
                                                        <h4><b>{{__('public.Town')}}</b></h4>
                                                        <h4><b>{{__('public.Email')}}</b></h4>
                                                        <h4><b>{{__('public.Start_Date')}}</b></h4>
                                                        <h4><b>{{__('public.End_Date')}}</b></h4>
                                                        <h4><b>{{__('public.Registration_deadline')}}</b></h4>
                                                        <h4><b>{{__('public.Registration_limit')}}</b></h4>
                                                        <h4><b>{{__('public.Organizer')}}</b></h4>
                                                        <h4><b>{{__('public.Couples')}}</b></h4>
                                                        <h4><b>{{__('public.Women')}}</b></h4>
                                                        <h4><b>{{__('public.Men')}}</b></h4>
                                                        <h4><b>{{__('public.Transgender')}}</b></h4>
                                                        <h4><b>{{__('public.Total_Participants')}}</b></h4>
                                                    </div>
