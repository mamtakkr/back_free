            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('public.Add_City')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body bg-ytr">
                            ...
                            <div class="tab-pane ladre" id="settings">
                                <form method="post" action="{{route('city-store')}}" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    <div class="form-group row">
                                        <label for="" class="col-sm-12 col-form-label">{{__('public.Country_Name')}}<span style="color: red;">*</span></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-12 col-form-label">{{__('public.City_Name')}}<span style="color: red;">*</span></label>
                                        <div class="col-sm-12">
                                            <input type="text" name="name" class="form-control" placeholder="{{__('public.City_Name')}}" value="{{old('name')}}">
                                        </div>
