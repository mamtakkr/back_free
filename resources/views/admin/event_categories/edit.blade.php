            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('event-categories')}}">{{__('public.Event_Categories')}}</a></li>
                        <li class="breadcrumb-item active">{{__('public.Edit_Event_Category')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body bg-ytr">
                            ...
                            <div class="tab-pane ladre" id="settings">
                                <form method="post" action="{{route('event-category-update')}}" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" placeholder="{{__('public.Title')}}" value="{{old('title',$category->title)}}">
                                        </div>
