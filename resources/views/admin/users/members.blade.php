...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('public.Members')}}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin-index')}}">{{__('public.Home')}}</a></li>
                        <li class="breadcrumb-item active">{{__('public.Members')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <table class="table table-striped table-bordered bulk_action datatable-checkbox" id="user_update">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{__('public.You_Are')}}</th>
                                                    <th>{{__('public.Experience')}}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select id="active_status" onchange="updateStatus({{$row['id']}},this.selectedIndex)" name="active_status">
                                                            <option value="active" <?php if ($row['active_status'] == 'active') echo "Selected"; ?>>{{__('public.Active')}}</option>
                                                            <option value="inactive" <?php if ($row['active_status'] == 'inactive') echo "Selected"; ?>>{{__('public.Inactive')}}</option>
                                                        </select>
                                                    </td>
                                                    <td>
