...
<section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('public.Term_Condition')}}</h1>
                </div>
            </div>
        </div>
    </section>
    				...
    				<form method="post" action="{{route('term-condition-update')}}" enctype="multipart/form-data" class="form-horizontal">
    					...
    					<div class="col-sm-12">
    						<div class="from_add">
    							...
    							<textarea name="terms_description" id="myeditor" class="form-control" placeholder="{{__('public.Description')}}">@if(!empty($terms->terms_description)) {{$terms->terms_description}} @else {{old('terms_description')}} @endif</textarea>
    						</div>
    					</div>
    					    <div class="sumiy">
