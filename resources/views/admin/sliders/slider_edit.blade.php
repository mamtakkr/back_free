                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{route('slider-update-action')}}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" placeholder="{{__('public.Title')}}" value="{{old('title',$slider->title)}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">{{__('public.Sub_Title')}}</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="sub_title" class="form-control" placeholder="{{__('public.Sub_Title')}}" value="{{old('sub_title',$slider->sub_title)}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">{{__('public.Image')}}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
                                            <button type="submit" class="btn btn-danger">{{__('public.Update')}}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
