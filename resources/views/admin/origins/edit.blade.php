...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('public.Origin')}}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin-index')}}">{{__('public.Home')}}</a></li>
                        <li class="breadcrumb-item"><a href="{{route('origins-index')}}">{{__('public.Origin')}}</a></li>
                        <li class="breadcrumb-item active">{{__('public.Edit_Origin')}}</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="tab-pane ladre" id="settings">
                                <form method="post" action="{{route('origin-update')}}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="name" class="form-control" placeholder="{{__('public.Name')}}" value="{{old('name',$origin->name)}}">
                                        </div>
