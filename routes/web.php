...
// 	Route::get('messages1/{id?}', [App\Http\Controllers\MessageController::class, 'messages1'])->name('messages1');
    ...
    Route::delete('account-delete/{id}', [App\Http\Controllers\UserController::class, 'accountDelete'])->name('account-delete');
...
// 	Route::POST('unsubscribe', [App\Http\Controllers\CheckoutController::class, 'unsubscribe'])->name('unsubscribe');
	...
	Route::get('fetchPhoto', [App\Http\Controllers\PhotoController::class, 'fetchPhoto'])->name('fetchPhoto');
	Route::delete('photo-delete/{id}', [App\Http\Controllers\PhotoController::class, 'deletePhoto'])->name('photo-delete');
    
    Route::post('photo-request-store', [App\Http\Controllers\PhotoController::class, 'requestStore'])->name('photo-request-store');
    Route::get('request-photos-show/{id}', [App\Http\Controllers\PhotoController::class, 'requestShow'])->name('request-photos-show');
    Route::post('request-photos-update', [\App\Http\Controllers\PhotoController::class, 'updateReqStatus'])->name('request-photos-update');
	...
	Route::get('fetchVideo', [App\Http\Controllers\VideoController::class, 'fetchVideo'])->name('fetchVideo');
	Route::delete('video-delete/{id}', [App\Http\Controllers\VideoController::class, 'deleteVideo'])->name('video-delete');
    
    Route::post('video-request-store', [App\Http\Controllers\VideoController::class, 'requestStore'])->name('video-request-store');
    Route::get('request-videos-show/{id}', [App\Http\Controllers\VideoController::class, 'requestShow'])->name('request-videos-show');
    Route::post('request-videos-update', [\App\Http\Controllers\VideoController::class, 'updateReqStatus'])->name('request-videos-update');
	...
	Route::get('user-videos/{id}', [App\Http\Controllers\SecretController::class, 'userVideos'])->name('user-videos');
...
Route::group(['prefix' => 'admin', 'middleware' => ['userRedirect']], function () {
    ...
    Route::get('messages-show', [\App\Http\Controllers\admin\MessageController::class, 'messageShow'])->name('messages-show');
    //Route::get('contacts-show', [\App\Http\Controllers\admin\CMSController::class, 'contactsShow'])->name('contacts-show');
    
    Route::get('photos-show', [\App\Http\Controllers\admin\PhotoController::class, 'photosShow'])->name('photos-show');
    Route::post('status-photos-update', [\App\Http\Controllers\admin\PhotoController::class, 'updateStatus'])->name('status-photos-update');
    
    Route::get('videos-show', [\App\Http\Controllers\admin\VideoController::class, 'videosShow'])->name('videos-show');
    Route::post('status-videos-update', [\App\Http\Controllers\admin\VideoController::class, 'updateStatus'])->name('status-videos-update');
