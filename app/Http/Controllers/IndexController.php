...
class IndexController extends Controller
{
    ...
    public function members()
    {
        ...
        return view('members', compact('members','origins','countries'));
    }
	...
	public function visits(Request $request)
    {
		...
		$visits = Visit::where(['user_id' => Auth::user()->id])->where('who_visit','!=',$user->id)->groupBy('who_visit')->orderBy('id','desc')->get();
