...
class OriginController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $origins->save();
        return redirect()->route('origins-index')->with('success', __("public.data_added"));
    }
    ...
    public function update(Request $request)
    {
        ...
        $origin->save();
        return redirect()->route('origins-index')->with('success', __("public.data_updated"));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('origins-index')->with('error', __("public.data_deleted"));
    }
