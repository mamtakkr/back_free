...
class User extends Authenticatable
{
    ...
    public function relPhoto(){
        return $this->hasMany('App\Models\Photo', 'user_id', 'id')->where('active_status','active');
    }
    
    public function relVideo(){
        return $this->hasMany('App\Models\Video', 'user_id', 'id')->where('active_status','active');
    }
