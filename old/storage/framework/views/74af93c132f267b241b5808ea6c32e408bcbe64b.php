        ...
        <nav>
          ...
          <div class="menu">
            <ul>
              ...
              <li> <a href="<?php echo e(route('members')); ?>" class="bg-standard-violet text-white px-2 py-2 <?php echo e((request()->segment(1) == 'members') || (request()->segment(1) == 'member-details') ? 'active' : ''); ?>"> <?php echo app('translator')->get('public.member'); ?> </a> </li>
...
<?php /**PATH C:\xampp\htdocs\freely\resources\views/layouts/partials/auth_header.blade.php ENDPATH**/ ?>