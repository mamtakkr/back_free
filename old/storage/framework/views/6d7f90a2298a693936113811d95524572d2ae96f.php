  ...
  <div class="row h-100 justify-content-center">
    <div class="col-lg-5 col-md-5 col-sm-6">
      <div class="coment bg-standard-grey mt-5 p-0">
        <div class="row">
          <div class="col-12 text-center resse py-2" style="border-radius: 8px 8px 0px 0px;">
            <h5><?php echo e($user_counter['member_details']->relUser->you_are); ?></h5>
          </div>
          ...
          <div class="col-12 py-2 border-top heading"> <span><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo e(strtoupper($user_counter['member_details']->city)); ?></span> </div>
        </div>
      </div>
      ...
      <div class="photos mt-5">
        ...
        <button class="mt-3 rounded bg-standard-violet text-white  px-2 py-2" data-toggle="modal" data-target="#addPhotoModal">Add Photo</button>
        <?php else: ?>
        
        <?php endif; ?> </div>
      <div class="photos mt-5">
        <p class="text-white">Videos
        <p>
        ...
        <?php if($user_counter['member_details']->user_id==Auth::user()->id): ?>
        <button class="mt-3 rounded bg-standard-violet text-white  px-2 py-2" data-toggle="modal" data-target="#addVideoModal">Add Video</button>
        <?php else: ?>
      ...
      <div class="coment bg-standard-grey mt-5">
        <div class="row">
          <div class="col-4  heading">
            <p>Profile</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Age')); ?></p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Size')); ?></p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Weight')); ?></p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Origin')); ?></p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Hair Size')); ?></p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Hair Colour')); ?></p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age"><?php echo e(__('Eye Colour')); ?></p>
          </div>
          <div class="col-4  heading">
            <p>Lui</p>
