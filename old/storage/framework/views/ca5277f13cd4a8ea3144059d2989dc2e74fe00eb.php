                        ...
                        <nav>
                            ...
                            <div class="menu">
                                <ul>
                                    ...
                                    <li>
                                        <a data-toggle="modal" data-target="#youModal" class="bg-standard-violet rounded-right  text-white px-2 py-2 active" href="<?php echo e(route('registerType')); ?>"><?php echo e(__('Register')); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
			...
			<div class="row h-100 justify-content-center">
    			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 login-area pt-5 pb-3">
    				<div class="dsew border text-center border-light p-5 rounded">
    				    <div class="row">
    						<div class="col-md-6">	
    						<a href="<?php echo e(route('member-register')); ?>" type="button" class=" mt-3 rounded bg-standard-violet text-white  px-2 py-2"><?php echo e(__('I am an individual')); ?></a>
    						</div>
    						<div class="col-md-6">
    						<a href="<?php echo e(route('professional-register')); ?>" type="button" class=" mt-3 rounded bg-standard-violet text-white  px-2 py-2"><?php echo e(__('I am a professional')); ?></a>
    						</div>
    					</div>	
    				</div>
    	        </div>
