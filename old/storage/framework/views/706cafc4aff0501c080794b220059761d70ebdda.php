                    ...
                    <div class="card">
                        <div class="card-body bg-ytr">
                            ...
                            <div class="tab-pane ladre" id="settings">
                                <form method="post" action="<?php echo e(route('origin-store')); ?>" enctype="multipart/form-data" class="form-horizontal">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demogswebtech/public_html/freely/resources/views/admin/origins/create.blade.php ENDPATH**/ ?>