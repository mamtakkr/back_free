      ...
      <div class="bg-img text-center" style="position: absolute;top: 50px;">
        ...
        <?php endif; ?>
          ...
          <div class="frd text-left">
            ...
            <p><i class="fa fa-ban" aria-hidden="true"></i><a href="<?php echo e(route('subscriptions',Auth::user()->id)); ?>">Subscriptions</a></p>
...
$(document).on("change","#image_url",function(){
   ...
   <?php /**PATH C:\xampp\htdocs\freely\resources\views/partials/after_login_index.blade.php ENDPATH**/ ?>