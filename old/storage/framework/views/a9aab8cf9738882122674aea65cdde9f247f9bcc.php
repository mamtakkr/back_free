                                        ...
                                        <table class="table table-striped table-bordered bulk_action datatable-checkbox" id="user_update">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-sm" href="<?php echo e(route('member-view',$row['id'])); ?>"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demogswebtech/public_html/freely/resources/views/admin/users/pending_members.blade.php ENDPATH**/ ?>