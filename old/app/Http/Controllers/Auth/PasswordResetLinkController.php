...
class PasswordResetLinkController extends Controller
{
     ...
     public function store(Request $request)
    {
        ...
        if(!empty($user))
        {
            ...
            <p style='text-align:left;'>You are receiving this email because we received a password reset request for your account<br></p>
            <br></strong>";
            ...
            return redirect()->back()->with('error', 'Email is not exists in the records.');
        }
