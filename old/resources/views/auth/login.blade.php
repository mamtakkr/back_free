      ...
      <div class="container">
        <div class="row">
          <nav>
            ...
            <div class="menu">
              <ul>
                <li><a class="bg-standard-violet rounded-left text-white px-2 py-2 active" href="{{route('login')}}">@lang('public.member')</a></li>
        ...
        <div class="login-form false">
          <div class="user-credentials ">
            ...
            <form action="{{ route('login') }}" method="post" class="louy login-form ">
              ...
              <div class="row">
                <div class="col-8">
                  <p class="white" >{{__('I am a professional')}}</p>
                </div>
                <div class="col-4">
              ...
              <div class="form-group text-center mt-3">
                <input type="submit" value="{{__('Login')}}" class="button mb-3 loci button d-block pt-1 pb-1 w-100 h-auto bg-standard-violet base-radius text-white text-uppercase font-weight-normal mx-auto">
              </div>
            </form>
          </div>
          <div class="row">
