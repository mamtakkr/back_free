    				...
    				<form method="post" action="{{route('equal-ment-update')}}" enctype="multipart/form-data" class="form-horizontal">
    					...
    					<div class="col-sm-12">
    						<div class="from_add">
    							...
    							<textarea name="equal_men_description" id="myeditor" class="form-control" placeholder="Description">@if(!empty($equal_m->equal_men_description)) {{$equal_m->equal_men_description}} @else {{old('equal_men_description')}} @endif</textarea>
    						</div>
    					</div>
    					    <div class="sumiy">
