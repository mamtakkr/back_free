    				...
    				<form method="post" action="{{route('privacy-policy-update')}}" enctype="multipart/form-data" class="form-horizontal">
    					...
    					<div class="col-sm-12">
    						<div class="from_add">
    							...
    							<textarea name="privacy_description" id="myeditor" class="form-control" placeholder="Description">@if(!empty($privacy->privacy_description)) {{$privacy->privacy_description}} @else {{old('privacy_description')}} @endif</textarea>
    						</div>
    					</div>
    					    <div class="sumiy">
