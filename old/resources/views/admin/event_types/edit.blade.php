            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('event-types')}}">Event Types</a></li>
                            ...
                            <div class="tab-pane ladre" id="settings">
                                <form method="post" action="{{route('event-type-update')}}" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" placeholder="Title" value="{{old('title',$type->title)}}">
                                        </div>
