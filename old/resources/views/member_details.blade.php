      ...
      <div class="coment bg-standard-grey mt-5 p-0">
        <div class="row">
          <div class="col-12 text-center resse py-2" style="border-radius: 8px 8px 0px 0px;">
            <h5>{{$user_counter['member_details']->relUser->you_are}}</h5>
          </div>
          ...
          <div class="col-12 py-2 border-top heading"> <span><i class="fa fa-map-marker" aria-hidden="true"></i> {{strtoupper($user_counter['member_details']->city)}}</span> </div>
        </div>
      </div>
      ...
      <div class="coment bg-standard-grey mt-5">
        <div class="row">
          <div class="col-4  heading">
            <p>Profile</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Age')}}</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Size')}}</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Weight')}}</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Origin')}}</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Hair Size')}}</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Hair Colour')}}</p>
            <p class=" pl-1 py-1 bg-standard-grey_lite Age">{{__('Eye Colour')}}</p>
          </div>
          <div class="col-4  heading">
            <p>Lui</p>
