              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-home"></i> Profile <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="{{route('change-password-edit')}}">Change Password</a></li>
                  </ul>
                </li>
                
                <li><a><i class="fa fa-home"></i> CMS <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{route('term-condition-edit')}}">Term & Condition</a></li>
                    <li><a href="{{route('privacy-policy-edit')}}">Privacy Policy</a></li>
                    <li><a href="{{route('equal-ment-edit')}}">Equal Mentions</a></li>
                ...
                <li><a><i class="fa fa-home"></i> Location <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{route('origins-index')}}">Origin</a></li>
                ...
                <li><a><i class="fa fa-home"></i> Events <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{route('event-categories')}}">Event Categories</a></li>
                    <li><a href="{{route('event-types')}}">Event Types</a></li>
                    <li><a href="{{route('events-pending')}}">Pending Events</a></li>
                    <li><a href="{{route('events-completed')}}">Completed Events</a></li>
                  </ul>
                </li>
                
                <li><a><i class="fa fa-home"></i> Users <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{route('members-show')}}">Registered Members</a></li>
                    <li><a href="{{route('professionals-show')}}">Registered Professionals</a></li>
                  </ul>
                </li>
                
                <li><a><i class="fa fa-home"></i> Request Approval <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="{{route('pending-members-show')}}">Pending Members</a></li>
                    <li><a href="{{route('pending-professionals-show')}}">Pending Professionals</a></li>
                  </ul>
                </li>
                
                <li><a href="{{route('plans')}}"><i class="fa fa-sitemap" aria-hidden="true"></i>Plans</a></li>
                
                
                <li><a href="{{route('index')}}" target="__blank"><i class="fa fa-sitemap" aria-hidden="true"></i>Visit Website</a></li>
              </ul>
            </div>
